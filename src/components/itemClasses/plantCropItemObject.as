package components.itemClasses 
{
	...
	public class plantCropItemObject extends cropItemObject 
	{
		...
		//-public
		//--static const
		public static const TYPE_CONSTRUCTOR:uint = MAINTYPES_LENGTH + DISTRIBUTABLETYPES_LENGTH + cropItemObject.CROPTYPES_LENGTH + equipmentItemObject.EQUIPMENTTYPES_LENGTH;//modify for all classes
